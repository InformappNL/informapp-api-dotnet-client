...
namespace Informapp.InformSystem.WebApi.Models.Version1.EndPoints.AppUsers.ListAppUser
{
        ...
        IRequest<ListAppUserV1Response>
    {
        ...
        [ExampleCollection(ExampleCollectionKind.List, typeof(ListAppUserV1Select), new object[] { ListAppUserV1Select.Email, ListAppUserV1Select.CustomerId })]
        [QueryParameter]
        [UniqueItems(typeof(ListAppUserV1Select))]
        public IEnumerable<ListAppUserV1Select> Select { get; set; } = new[] { ListAppUserV1Select.All };
        ...
        public IEnumerable<ListAppUserV1Sort> Sort { get; set; } = new[] { ListAppUserV1Sort.Email };
