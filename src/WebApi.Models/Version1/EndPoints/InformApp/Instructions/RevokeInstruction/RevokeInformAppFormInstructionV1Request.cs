...
namespace ConnectedDevelopment.InformSystem.WebApi.Models.Version1.EndPoints.InformApp.Instructions.RevokeInstruction
{
    ...
    [Path(InformAppInstructionV1Constants.RevokeRoute)]
    [Response(HttpStatusCode.BadRequest, typeof(BadRequestV1Response))]
    [Response(HttpStatusCode.Forbidden, typeof(ForbiddenV1Response))]
    [Response(HttpStatusCode.InternalServerError, typeof(InternalServerErrorV1Response))]
    [Response(HttpStatusCode.Unauthorized, typeof(UnauthorizedV1Response))]
    public class RevokeInformAppFormInstructionV1Request : BaseRequest,
        IRequest<RevokeInformAppFormInstructionV1Response>
    {
        /// <summary>
        /// Form id
        /// </summary>
