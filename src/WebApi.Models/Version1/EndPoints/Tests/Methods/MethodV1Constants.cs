...
namespace ConnectedDevelopment.InformSystem.WebApi.Models.Version1.EndPoints.Tests.Methods
{
    internal static class MethodV1Constants
    {
        internal const string Route = "api/v1/tests/methods";
