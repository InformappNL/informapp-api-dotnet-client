...
{
    public partial class DownloadDataSourceV1Response : IExampleMemberProvider
    {
...
4  86        32         The New Holland Bridge";
        ...
        static DownloadDataSourceV1Response()
        {
        ...
        private static void Assignable(DownloadDataSourceV1Response response)
        {
