...
{
    /// <summary>
    /// List integration export queued for me request
    /// </summary>
    [DataContract(Namespace = Version1Constants.Namespace)]
    [HttpMethod(HttpMethod.Get)]
    [Path(IntegrationExportV1Constants.ListQueuedForMeRoute)]
    [Response(HttpStatusCode.BadRequest, typeof(BadRequestV1Response))]
    [Response(HttpStatusCode.Forbidden, typeof(ForbiddenV1Response))]
    [Response(HttpStatusCode.InternalServerError, typeof(InternalServerErrorV1Response))]
    [Response(HttpStatusCode.Unauthorized, typeof(UnauthorizedV1Response))]
    public class ListIntegrationExportQueuedForMeV1Request : BaseRequest,
        IRequest<ListIntegrationExportQueuedForMeV1Response>
    {
        /// <summary>
        /// Page number
        /// </summary>
        ...
        [QueryParameter]
        [Range(Version1PageSizeConstants.Min, IntegrationExportV1Constants.PageSizeMaxValue)]
