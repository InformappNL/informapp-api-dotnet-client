...
{
    /// <summary>
    /// Register factor interceptors in Autofac
    /// </summary>
    public class FactoryInterceptorT1Registration : IAutofacRegistration
    {
        private readonly IAssemblyProvider _assemblyProvider;

        /// <summary>
        /// Initializes a new instance of the <see cref="FactoryInterceptorT1Registration"/> class.
        /// </summary>
        public FactoryInterceptorT1Registration(
