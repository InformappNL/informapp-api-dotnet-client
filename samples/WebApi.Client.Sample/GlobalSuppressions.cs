...
namespace Informapp
{
    ...
    {
        public const string ResourceNameSpace = nameof(Informapp) + "." + nameof(InformSystem) + "." + nameof(InformSystem.WebApi) + "." + nameof(InformSystem.WebApi.Client) + "." + nameof(InformSystem.WebApi.Client.Sample);
    }
}
