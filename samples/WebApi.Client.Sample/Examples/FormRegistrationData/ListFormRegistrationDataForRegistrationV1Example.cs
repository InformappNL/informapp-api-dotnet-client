...
using ConnectedDevelopment.InformSystem.WebApi.Models.Version1.EndPoints.FormRegistrationData;
...
namespace ConnectedDevelopment.InformSystem.WebApi.Client.Sample.Examples.FormRegistrationData
{
    /// <summary>
